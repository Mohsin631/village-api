...
<div class="card-soft">
  <div class="d-flex flex-wrap align-items-center justify-content-between gap-2 mb-3">
    ...
    <div class="d-flex flex-wrap gap-2">
      ...
      <a href="{{ route('admin.newsletters.export', request()->query()) }}" class="btn btn-outline-secondary">
  ...
  <form method="GET" class="row g-2 align-items-end mb-3">
    ...
    <div class="col-12 col-sm-6 col-md-4 col-lg-3">
      <a href="{{ route('admin.newsletters.index') }}" class="btn btn-outline-light w-100">
    ...
    <table class="table align-middle" id="newsletterTable">
      ...
      <tbody>
        @forelse ($items as $i => $row)
          <tr>
            <td>
              <input type="checkbox" class="row-check" value="{{ $row->id }}" data-email="{{ $row->email }}">
            </td>
...
{{-- Inline script: robust + layout-agnostic --}}
<script>
